...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    meta: [
      ...
      { title: "Ganado Digital" },
      { name: "description", content: "Control sanitario y reproductivo del rancho." },
      { name: "theme-color", content: "#0f2a1d" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "Ganado" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "Ganado Digital" },
      { property: "og:description", content: "Control sanitario y reproductivo del rancho." },
      { property: "og:type", content: "website" },
    ],
  }),
