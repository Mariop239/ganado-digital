...
export const vacunaSchema = z
  .object({
    ...
    estado_tratamiento: estadoTratamientoEnum.default("aplicado"),
    fecha: z.string().nullable().optional(),
    vacuna_aplicada: z.string().trim().min(1, "Requerida").max(150),
    enfermedad_a_prevenir: z.string().trim().max(150).default(""),
    gasto: z.number({ message: "Debe ser un número" }).min(0, "Debe ser ≥ 0").default(0),
