...
import { useVacunasPorAnimal } from "../hooks/useVacunas";
import { FormVacuna } from "./FormVacuna";
import { VacunaDetailSheet } from "./VacunaDetailSheet";
import {
...
import type { Vacuna } from "../types/domain";
...
export function VacunasTablaVaca({ animalId }: Props) {
  ...
  return (
    <section className="space-y-3">
      ...
      <VacunaDetailSheet vacuna={detail} onClose={() => setDetail(null)} />
    </section>
  );
}
